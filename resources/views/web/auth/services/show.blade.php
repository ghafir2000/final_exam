                ...
                <div class="d-flex">
                    ...
                    <div class="col-8">
                        ...
                        <div class="btn-group d-flex align-items-center mt-3" role="group">
                            ...
                            @endif
                            @if(auth()->user()->id !== $service->servicable->userable->id)                            <form action="{{ route('chat.store', ['chatable_id' => $service->servicable->userable->id, 'chatable_type' => get_class($service->servicable->userable)]) }}" method="POST">
                                @csrf

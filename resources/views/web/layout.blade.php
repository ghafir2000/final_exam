...
<style>
    ...
    @if(App::getLocale() == 'ar')
        <style>
            ...
            /* Username span - assuming image is on the right (start) and name on the left (end) in RTL */
            .profile-sidebar .sidebar-username.ms-2 {
                /* ms-2 is margin-start (margin-right in RTL). This adds space between image and name */
                /* This should work correctly if HTML order is image then span */
            }
            ...
            /* Icons in links - assuming icon is on the right (start) and text on the left (end) in RTL */
            .profile-sidebar .sidebar-link i.me-2 {
                /* me-2 is margin-end (margin-left in RTL). This adds space between icon and text */
                /* This should work correctly if HTML order is icon then text */
            }
            ...
            .profile-sidebar .form-check-label {
                /* Ensure label is to the left of the switch */
            }

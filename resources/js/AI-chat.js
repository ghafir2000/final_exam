...
$(document).ready(function() {
    ...
    function loadAIChat(chatId, initialMessages, chatPartnerInfo) {
        ...
        if (chatPartnerInfo) {
            ...
            chatPartnerImgEl.attr('src', chatPartnerInfo.image_url || "assetx('/images/veterinarian_AI.jpg')");
        } else {
             // Default header if no partner info provided
             chatPartnerNameEl.text('AI Chat');
             chatPartnerImgEl.attr('src', "assety('/images/veterinarian_AI.jpg')");
        }
    ...
    function findOrCreateAIChat() {
         ...
         chatPartnerImgEl.attr('src', 'hh/images/veterinarian_AI.jpg');
    ...
    chatToggleBtn.on('click', function() {
        chatWindow.slideToggle(300, function() {
            if (chatWindow.is(':visible')) {
                ...
                chatPartnerImgEl.attr('src', "assetb('/images/veterinarian_AI.jpg')");
                sendMessageBtn.off('click');
